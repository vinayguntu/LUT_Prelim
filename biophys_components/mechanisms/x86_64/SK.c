...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK /Users/latimerb/LUT_Prelim/biophys_components/mechanisms/x86_64/SK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/latimerb/LUT_Prelim/biophys_components/mechanisms/modfiles/SK.mod";
static const char* nmodl_file_text = 
