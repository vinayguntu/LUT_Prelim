...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ka /home/mjc598/fork/LUT_Prelim/biophys_components/mechanisms/x86_64/ka.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mjc598/fork/LUT_Prelim/biophys_components/mechanisms/modfiles/ka.mod";
static const char* nmodl_file_text = 
  ": A-type  K+ CHANNEL (KA)\n"
  "\n"
  "NEURON {\n"
